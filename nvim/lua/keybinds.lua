...
key_mapper('n','nt',':NvimTreeToggle<CR>')
key_mapper('n','ny',':NvimTreeFocus<CR>')
...
-- wijilers binds
key_mapper('n','wf', ':w<CR>')
key_mapper('i','wf', '<ESC>:w<CR>')
key_mapper('n','qq',':q<CR>')
key_mapper('n','c','o<ESC>')

key_mapper('n','ff',':Telescope find_files<CR>')
